          ...
          <div className="values-section">
            ...
            <div className="values-section-title">
              ...
              <div className="values-content">
                <p>
                  We're driven by a set of core values that shape our culture,
                  guide our decisions, and inspire our actions. These principles
                  are the foundation of our organization, and they influence
                  everything we do.
                </p>
              </div>
            </div>
              ...
              <div className="row justify-content-center">
                ...
                >
                  ...
                  <div className="icon-body">
                    ...
                    <div className="icon-description">
                      <p>
                        {" "}
                        We foster a culture of continuous innovation, constantly
                        seeking new ways to push technological boundaries and
                ...
                >
                  ...
                  <div className="icon-body">
                    ...
                    <div className="icon-description">
                      <p>
                        We strive for excellence in everything we do, from chip
                        design to customer service, ensuring the highest
              ...
              <div className="row justify-content-center">
                ...
                >
                  ...
                  <div className="icon-body">
                    ...
                    <div className="icon-description">
                      <p>
                        We believe in the power of collaboration, working
                        closely with our partners, clients, and stakeholders to
