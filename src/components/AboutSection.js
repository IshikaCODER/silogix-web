                    ...
                    <div className="about-section custom-row align-items-center">
                        ...
                        <div className="section-img">
                            <div className="img-area">
                                <img src={img1} className="about-img" id="aboutImg1" alt="img1" />
                                <img src={img2} className="about-img" id="aboutImg2" alt="img2" />
                            </div>
                            <div className="img-area">
                                <img src={img3} className="about-img" id="aboutImg3" alt="img3" />
                                <img src={img4} className="about-img" id="aboutImg4" alt="img4" />
                            </div>
                        </div>
